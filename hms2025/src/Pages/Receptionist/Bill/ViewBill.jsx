...
const ViewBill = () => {
    ...
    useEffect(() => {
        const fetchBillDetails = async () => {
            try {
                ...
                // Fetch Patient (if name not in bill object)
                let patName = "";
                if (patId) {
    ...
    const generatePDF = () => {
        ...
        doc.setFontSize(16);
        doc.text("Consultation Bill", 105, 30, { align: "center" });

        // Bill Info
        doc.setFontSize(12);
        doc.text(`Bill ID: ${bill.ConsultationBill_id || bill.id}`, 14, 50);
        ...
        doc.save(`Bill_${bill.ConsultationBill_id || bill.id}.pdf`);
    };
                ...
                <div className="card-body">
                    <div className="row mb-3">
                        ...
                        <div className="col-md-6 text-end">
                            <h5>Bill Info</h5>
                            <p><strong>Bill ID:</strong> {bill.ConsultationBill_id || bill.id}</p>
